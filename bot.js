...
client.on("messageCreate", (message) => {
	if (message.content == "dream") { 
		message.channel.send("In this video 3 of my friends try and hunt me down! If I kill the Ender Dragon I win but if they kill me once I lose. \nThis is Minecraft Manhunt. \nAlso, only a small percentage of people who watch my videos are subscribed, so make sure you subscribe. This really helps me out a lot! So, let's get straight into the video! \n\n(_Dream Minecraft Manhunt music starts playing!_) \n\n(_Dream killed the Ender Dragon and won!!_)"); 
	} 
	
	if (message.content == "technoblade") { 
		message.channel.send("Hail TECHNOBLADE!!!! \n\nTECHNOBLADE NEVER DIES"); 
	}
	
	if (message.content == "wilbursoot") { 
		message.channel.send("2 to the 1 to the 1 to the 3 Please get TommyInnit off my screen!!"); 
	}
	if (message.content == "bbs") { 
		message.channel.send("Hey Fellas Beast boy here!"); 
	}
	if (message.content == "rasode me kon tha?") { 
		message.channel.send("Rashi Ben"); 
	}
	if (message.content == "drista") { 
		message.channel.send("Tommy I need help Dream hit me! Help me TommyInnit!"); 
	}
	if (message.content == "lets fight") { 
		message.reply("I am gonna kill you!"); 
	}
	if (message.content == "no u") { 
		message.channel.send("Aaaah, You killed me. \nYou won't live a peaceful life!"); 
	}
	if (message.content == "ghostbot") { 
		message.channel.send("Boooooo! I am the ghost of the client you killed!"); 
	}
	if (message.content == "so what") { 
		message.channel.send("You know what? I won't fight you! \nYou are just a waste of time! \nBYE"); 
	}
	if (message.content == "RIP") { 
		message.channel.send("let's keep silence of 2 minutes for Our Loved friend!!");
	}
	...
	if (message.content == "Saale") {
		message.delete();
		message.reply ("No bad Words allowed!");
	}
	if (message.content == "Kutte") {
		message.delete();
		message.reply ("No bad Words allowed!"); 
	} 
